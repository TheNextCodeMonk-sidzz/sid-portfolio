...
const Project_card = ({image, title, description, github, tech, index}) => {
  ...
  return (
    ...
    >
      ...
      <div className='p-6'>
        <div className='mb-4'>
          <h3 className='text-2xl font-bold text-white mb-3 group-hover:text-zinc-400 transition-colors'>
            {title}
          </h3>
        ...
        >
          ...
          <span>View Code</span>
          <GoArrowUpRight className='text-sm transition-transform duration-300 group-hover:translate-x-1 group-hover:-translate-y-1' />
        </a>
      </div>
