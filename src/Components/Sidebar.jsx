...
const Sidebar = () => {
  return (
    <div className="w-60 h-screen bg-zinc-800 text-white fixed top-0 left-0 flex flex-col justify-between p-4" style={{backgroundColor: '#1C1C1C'}}>
      <div>
        ...
        <nav className="space-y-4 ">
          <MenuItem link="/" icon={home} label="Home" />
...
const MenuItem = ({ icon, label ,link}) => (
  <NavLink to={link} className="flex items-center gap-3 text-sm hover:bg-zinc-800 px-2 py-1 rounded cursor-pointer transition" >
